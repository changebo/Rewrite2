...
class DCGAN(object):
  ...
  def generator(self, source):
    with tf.variable_scope("generator") as scope:
      ...
      h0 = lrelu(self.g_bn0(conv2d(source, self.gf_dim, name='g_h0_conv')))
      h1 = lrelu(self.g_bn1(conv2d(h0, self.gf_dim << 1, name='g_h1_conv')))
      h2 = lrelu(self.g_bn2(conv2d(h1, self.gf_dim << 2, name='g_h2_conv')))
      h3 = lrelu(self.g_bn3(conv2d(h2, self.gf_dim << 3, name='g_h3_conv')))
      h4 = lrelu(self.g_bn4(linear(tf.reshape(h3, [self.batch_size, -1]), 4096, 'g_h4_lin')))
      h5 = linear(h4, 100, 'g_h5_lin')
      h5 = tf.reshape(h5, [self.batch_size, 1, 1, -1])

      h6 = lrelu(self.g_bn5(deconv2d(h5, 
        [self.batch_size, s_h16, s_w16, self.gf_dim << 4], k_h=4, k_w=4, d_h=self.target_height >> 4, d_w=self.target_height >> 4, name='g_h6_deconv')))
      h7 = lrelu(self.g_bn6(deconv2d(h6, 
        [self.batch_size, s_h8, s_w8, self.gf_dim << 3], k_h=4, k_w=4, name='g_h7_deconv')))
      h8 = lrelu(self.g_bn7(deconv2d(h7, 
        [self.batch_size, s_h4, s_w4, self.gf_dim << 2], k_h=4, k_w=4, name='g_h8_deconv')))
      h9 = lrelu(self.g_bn8(deconv2d(h8, 
        [self.batch_size, s_h2, s_w2, self.gf_dim << 1], k_h=4, k_w=4, name='g_h9_deconv')))      
      h10 = lrelu(deconv2d(h9, 
        [self.batch_size, s_h, s_w, self.c_dim], k_h=4, k_w=4, name='g_h10_deconv'))
      return tf.nn.sigmoid(h10)
  ...
  def sampler(self, source, y=None):
    with tf.variable_scope("generator") as scope:
      ...
      h2 = lrelu(self.g_bn2(conv2d(h1, self.gf_dim << 2, name='g_h2_conv')))
      h3 = lrelu(self.g_bn3(conv2d(h2, self.gf_dim << 3, name='g_h3_conv')))
      h4 = lrelu(self.g_bn4(linear(tf.reshape(h3, [self.test_num, -1]), 4096, 'g_h4_lin')))
      h5 = linear(h4, 100, 'g_h5_lin')
      h5 = tf.reshape(h5, [self.test_num, 1, 1, -1])

      h6 = lrelu(self.g_bn5(deconv2d(h5, 
        [self.test_num, s_h16, s_w16, self.gf_dim << 4], k_h=4, k_w=4, d_h=self.target_height >> 4, d_w=self.target_height >> 4, name='g_h6_deconv')))
      h7 = lrelu(self.g_bn6(deconv2d(h6, 
        [self.test_num, s_h8, s_w8, self.gf_dim << 3], k_h=4, k_w=4, name='g_h7_deconv')))
      h8 = lrelu(self.g_bn7(deconv2d(h7, 
        [self.test_num, s_h4, s_w4, self.gf_dim << 2], k_h=4, k_w=4, name='g_h8_deconv')))
      h9 = lrelu(self.g_bn8(deconv2d(h8, 
        [self.test_num, s_h2, s_w2, self.gf_dim << 1], k_h=4, k_w=4, name='g_h9_deconv')))      
      h10 = lrelu(deconv2d(h9, 
        [self.test_num, s_h, s_w, self.c_dim], k_h=4, k_w=4, name='g_h10_deconv'))
      return tf.nn.sigmoid(h10)
